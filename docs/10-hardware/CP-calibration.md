...
!!! note "NOTE"
    When designing a new voltage divider, remember the ESP32 adc [_suggested range_](https://docs.espressif.com/projects/esp-idf/en/v4.4.3/esp32/api-reference/peripherals/adc.html#_CPPv425adc1_config_channel_atten14adc1_channel_t11adc_atten_t) (adc is configured for attenuation 11dB).